...
@NoArgsConstructor
public class ManualReorderUpCommand implements UserCommand {

    public static final String COMMAND_NAME = "/manual_r_up";
    ...
    public MessageToUser execute(MessageDTO message) {
        ...
        try {
            ...
            try {
                GuideRepository.swapSubsectionWithNeighbor(subsectionId, true);
