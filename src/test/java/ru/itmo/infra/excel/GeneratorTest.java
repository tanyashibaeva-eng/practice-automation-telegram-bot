...
class GeneratorTest {
    ...
    void testGenerateExcelWithErrors() throws InternalException, IOException {
        ...
        try (var fis = new FileInputStream(file)) {
            ...
            assertEquals("Имя Компании", headerRow.getCell(6).getStringCellValue());
            assertEquals("ФИО Руководителя", headerRow.getCell(7).getStringCellValue());
            ...
            assertEquals(12345, dataRow1.getCell(5).getNumericCellValue());
            ...
            assertEquals(2, dataRow2.getCell(0).getNumericCellValue());
            ...
            assertEquals(67890, dataRow2.getCell(5).getNumericCellValue());
